...
const Certifications = () => {
  ...
  const items = [
    ...
    <p key="empresa" className="mx-auto mt-4 max-w-3xl text-lg text-gray-600">
    ...
    <p key="compromiso" className="mx-auto mt-4 max-w-3xl text-lg text-gray-600">
  ...
  return (
    <div className="mx-auto max-w-7xl pt-24 sm:px-2 sm:pt-36 lg:px-4">
